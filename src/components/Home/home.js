  ...
  useEffect(() => {
    (function () {
      ...
      function initHeader() {
        ...
        largeHeader = document.getElementsByClassName("large-header")[0];
        largeHeader.style.height = height + "px";

        canvas = document.getElementsByClassName("demo-canvas")[0];
        canvas.width = width;
    ...
    <div className="container demo">
      <div className="content">
        <div id="large-header" className="large-header">
          <canvas className="demo-canvas" id="demo-canvas"></canvas>
